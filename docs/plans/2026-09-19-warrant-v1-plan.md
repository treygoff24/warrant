...
persona = "minimalist-implementer"
skills = ["rust-engineer", "tdd"]
owned_files = ["crates/core/src/eval", "crates/cli/src/commands/policy.rs", "crates/cli/src/commands/inventory.rs", "tests/conformance/claims", "tests/conformance/demo.py", "tests/acceptance.d/03-inventory-unowned.sh", "crates/core/src/schema/obligations.rs", "schemas/warrant.obligations.json"]
...
persona = "repro-first-writer"
skills = ["rust-engineer", "tdd", "house-bar"]
owned_files = ["scripts/stages/60-mutants.sh", "crates/core/src/fault.rs", "crates/cli/src/cache.rs", "crates/cli/tests/cli.rs", "tests/conformance/adversarial", "tests/conformance/offline", "tests/acceptance.d/01-gate.sh", "scripts/stages/REQUIRED", "tests/acceptance.d/REQUIRED"]
