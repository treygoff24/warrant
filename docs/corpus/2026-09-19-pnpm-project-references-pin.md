...
The repository carries an Apache-2.0 license. The dependency bundle still needs its own redistribution review. Digests and the complete dependency bundle identity are in `tests/corpus/manifest.yaml`.
